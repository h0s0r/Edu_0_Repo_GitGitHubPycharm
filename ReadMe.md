...
| `git bisect start / good / bad`     | Binary hunts for commit causing a bug             | `git bisect start → git bisect good <commit>`          |
...
### C. QUICK PYCHARM REFERENCE

• Enable Git: VCS → Enable Version Control Integration  
...
**Install PyCharm**  
• Get it from [https://www.jetbrains.com/pycharm/download](https://www.jetbrains.com/pycharm/download)
...
You now have:  
1. A quick table-based summary.  
2. A medium-depth quick explanation.  
3. A full zero-to-hero step-by-step guide.